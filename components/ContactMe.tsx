...
export default function ContactMe() {
    ...
    return(
        <div className='min-h-screen relative flex flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
            ...
            <div className='flex md:mt-32 mt-52 absolute flex-col space-y-6'>
                ...
                <form className='md:mx-auto md:w-fit space-y-2 flex pb-10 flex-col' onSubmit={handleSubmit(onSubmit)}>
