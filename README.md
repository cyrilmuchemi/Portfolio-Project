...
[Live Demo Link](https://cyril-muchemi.vercel.app/)
...
-[Download the ZIP from this location](https://github.com/cyrilmuchemi/Portfolio-Project), or run the following [git](https://git-scm.com/downloads) command to clone the files to your machine:

-```bash
git clone https://github.com/cyrilmuchemi/Portfolio-Project. 
